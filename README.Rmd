...
[![Travis build status](https://travis-ci.com/poissonconsulting/dbflobr.svg?branch=master)](https://travis-ci.com/poissonconsulting/dbflobr)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/4yop2q92batu2e25/branch/master?svg=true)](https://ci.appveyor.com/project/poissonconsulting/dbflobr/branch/master)
...
[![Tinyverse status](https://tinyverse.netlify.com/badge/dbflobr)](https://CRAN.R-project.org/package=dbflobr)
...
Please note that this project is released with a [Contributor Code of Conduct](https://github.com/poissonconsulting/dbflobr/blob/master/CODE_OF_CONDUCT.md).
